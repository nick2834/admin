suber.factory('getData',function(getTaskUrl){
        return {
            ...
            userCount:function(param){//用户总数
                param = param ||  '';
                return getTaskUrl.goSend2({url:'/users/num.json'+param,headers:{Authorization:'Token token='+eval((sessionStorage.getItem("authentication_token")))+',phone='+eval(sessionStorage.getItem("phone"))}}).then(function(data){
                    return data;
                })
            },
            ...
            userDetail:function(param){
                param = '?page='+param ||  '';
                return getTaskUrl.goSend2({url:'/users/info.json'+param,headers:{Authorization:'Token token='+eval((sessionStorage.getItem("authentication_token")))+',phone='+eval(sessionStorage.getItem("phone"))}}).then(function(data){
                    return data;
                })
            },
            ...
            balanceList:function(uid){
                return getTaskUrl.goSend2({url:'/users/'+uid+'/wallet.json',headers:{Authorization:'Token token='+eval((sessionStorage.getItem("authentication_token")))+',phone='+eval(sessionStorage.getItem("phone"))}}).then(function(data){
                    return data;
                })
            },
            ...
            getWallet:function(userId){
                return getTaskUrl.goSend({url:'/api/v1/users/'+userId+'.json',headers:{Authorization:'Token token='+eval((sessionStorage.getItem("authentication_token")))+',phone='+eval(sessionStorage.getItem("phone"))}}).then(function(data){
                    return data;
                })
            },
